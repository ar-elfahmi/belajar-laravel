                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination m-0">
                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ $data_role->previousPageUrl() }}" aria-label="Previous">
                                                            <span aria-hidden="true">&laquo;</span>
                                                            <span class="sr-only">Previous</span>
                                                        </a>
                                                    </li>
                                                    <li class="page-item"><a class="page-link" href="{{$data_role->url(1) }}">1</a></li>
                                                    <li class="page-item"><a class="page-link" href="{{$data_role->url(2) }}">2</a></li>
                                                    <li class="page-item"><a class="page-link" href="{{$data_role->url(3) }}">3</a></li>

                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ $data_role->nextPageUrl() }}" aria-label="Next">
                                        ...
                                        <table class="table table-striped">
                                            <thead class="table-primary">
                                                <tr>
                                                    ...
                                                    <th class="col-md-5">Nama Role</th>
                                                    <th class="col-md-2">Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @forelse($data_role as $role => $value)
                                                <tr>
