                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tambah Data Ras Hewan</h3>
                                        ...
                                        <div class="my-3 p-3 bg-body rounded shadow-sm">
                                            <form action="{{ route('ras-hewan.store') }}" method="POST">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="nama_ras" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-select" name="idjenis_hewan" required>
                                                            ...
                                                            <option value="{{ $jenis_hewan->idjenis_hewan }}">{{ $jenis_hewan->nama_jenis_hewan }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
