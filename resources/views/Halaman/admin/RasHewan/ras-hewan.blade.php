        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Data Master Ras Hewan</h3>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination m-0">
                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ $data_ras_hewan->previousPageUrl() }}" aria-label="Previous">
                                                            <span aria-hidden="true">&laquo;</span>
                                                            <span class="sr-only">Previous</span>
                                                        </a>
                                                    </li>
                                                    <li class="page-item"><a class="page-link" href="{{$data_ras_hewan->url(1) }}">1</a></li>
                                                    <li class="page-item"><a class="page-link" href="{{$data_ras_hewan->url(2) }}">2</a></li>
                                                    <li class="page-item"><a class="page-link" href="{{$data_ras_hewan->url(3) }}">3</a></li>

                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ $data_ras_hewan->nextPageUrl() }}" aria-label="Next">
                                        ...
                                        <table class="table table-striped">
                                            <thead class="table-primary">
                                                <tr>
                                                    ...
                                                    <th class="col-md-3">Nama Ras</th>
                                                    <th class="col-md-4">Jenis Hewan</th>
                                                    <th class="col-md-2">Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @forelse($data_ras_hewan as $ras_hewan => $value)
                                                <tr>
                                                    <td>{{ $data_ras_hewan->firstItem() + $ras_hewan }}</td>
