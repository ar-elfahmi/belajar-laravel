                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tabel Data Detail Rekam Medis</h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="my-3 p-3 bg-body rounded shadow-sm">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination m-0">
                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ $data_detail_rekam_medis->previousPageUrl() }}" aria-label="Previous">
                                                            <span aria-hidden="true">&laquo;</span>
                                                            <span class="sr-only">Previous</span>
                                                        </a>
                                                    </li>
                                                    <li class="page-item"><a class="page-link" href="{{$data_detail_rekam_medis->url(1) }}">1</a></li>
                                                    <li class="page-item"><a class="page-link" href="{{$data_detail_rekam_medis->url(2) }}">2</a></li>
                                                    <li class="page-item"><a class="page-link" href="{{$data_detail_rekam_medis->url(3) }}">3</a></li>

                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ $data_detail_rekam_medis->nextPageUrl() }}" aria-label="Next">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                @forelse($data_detail_rekam_medis as $detail => $value)
                                                <tr>
                                                    <td>{{ $data_detail_rekam_medis->firstItem() + $detail }}</td>
