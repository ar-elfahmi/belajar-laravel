                                ...
                                <div class="card-body">
                                    ...
                                    <div class="my-3 p-3 bg-body rounded shadow-sm">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <a href="{{ route('perawat.tambah-pet') }}" class="btn btn-primary">Tambah Pet</a>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('perawat.edit-pet', $value->idpet) }}" class="btn btn-warning btn-sm">Edit</a>
                                                        <a href="{{ route('perawat.pet.hapus', $value->idpet) }}" class="btn btn-danger btn-sm">Delete</a>
                                                    </td>
                                                </tr>
                                                @empty
                                                <tr>
