                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Data Detail Rekam Medis</h3>
                                        ...
                                        <div class="my-3 p-3 bg-body rounded shadow-sm">
                                            <form action="{{ route('dokter.detail-rekam-medis.update', $data_detail_rekam_medis->iddetail_rekam_medis) }}" method="POST">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-select" name="idrekam_medis" required>
                                                            ...
                                                            <option value="{{ $rekam->idrekam_medis }}" {{ $data_detail_rekam_medis->idrekam_medis == $rekam->idrekam_medis ? 'selected' : '' }}>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-select" name="idkode_tindakan_terapi" required>
                                                            ...
                                                            <option value="{{ $tindakan->idkode_tindakan_terapi }}" {{ $data_detail_rekam_medis->idkode_tindakan_terapi == $tindakan->idkode_tindakan_terapi ? 'selected' : '' }}>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control" name="detail" rows="3" required>{{ old('detail', $data_detail_rekam_medis->detail) }}</textarea>
                                                    </div>
                                                </div>
