...
//     // Route::get('/pemilik', [PemilikController::class, 'pemilik'])->name('resepsionis.pemilik'); // halaman data master pemilik
//     // Route::get('/pemilik/tambah-pemilik', [PemilikController::class, 'tambahPemilik'])->name('resepsionis.tambah-pemilik'); // halaman tambah pemilik
//     // Route::get('/pemilik/edit-pemilik/{idpemilik}', [PemilikController::class, 'editPemilik'])->name('resepsionis.edit-pemilik'); // halaman edit pemilik
//     Route::post('/pemilik/store', [PemilikController::class, 'store'])->name('resepsionis.pemilik.store'); // untuk tambah data pemilik
//     Route::put('/pemilik/update/{idpemilik}', [PemilikController::class, 'update'])->name('resepsionis.pemilik.update'); // untuk edit data pemilik
//     // Route::get('/pemilik/hapus/{idpemilik}', [PemilikController::class, 'destroy'])->name('resepsionis.pemilik.hapus'); // untuk hapus data pemilik

//     // Route::get('/pet', [PetController::class, 'pet'])->name('resepsionis.pet'); // halaman data master pet
//     Route::get('/pet/tambah-pet', [PetController::class, 'tambahPet'])->name('resepsionis.tambah-pet'); // halaman tambah pet
//     Route::get('/pet/edit-pet/{idpet}', [PetController::class, 'editPet'])->name('resepsionis.edit-pet'); // halaman edit pet
//     Route::post('/pet/store', [PetController::class, 'store'])->name('resepsionis.pet.store'); // untuk tambah data pet
//     Route::put('/pet/update/{idpet}', [PetController::class, 'update'])->name('resepsionis.pet.update'); // untuk edit data pet
//     Route::get('/pet/hapus/{idpet}', [PetController::class, 'destroy'])->name('resepsionis.pet.hapus'); // untuk hapus data pet

//     // Route::get('/temu-dokter', [TemuDokterController::class, 'temu_dokter'])->name('resepsionis.temu-dokter'); // halaman data master temu dokter
//     Route::get('/temu-dokter/tambah-temu-dokter', [TemuDokterController::class, 'tambahTemuDokter'])->name('resepsionis.tambah-temu-dokter'); // halaman tambah temu dokter
//     Route::get('/temu-dokter/edit-temu-dokter/{idreservasi_dokter}', [TemuDokterController::class, 'editTemuDokter'])->name('resepsionis.edit-temu-dokter'); // halaman edit temu dokter
//     Route::post('/temu-dokter/store', [TemuDokterController::class, 'store'])->name('resepsionis.temu-dokter.store'); // untuk tambah data temu dokter
//     Route::put('/temu-dokter/update/{idreservasi_dokter}', [TemuDokterController::class, 'update'])->name('resepsionis.temu-dokter.update'); // untuk edit data temu dokter
//     Route::get('/temu-dokter/hapus/{idreservasi_dokter}', [TemuDokterController::class, 'destroy'])->name('resepsionis.temu-dokter.hapus'); // untuk hapus data temu dokter

//     // Route::get('/beranda', [BerandaController::class, 'index'])->name('resepsionis.beranda'); // halaman dashboard resepsionis
// });
...
//     Route::get('/data-pasien', [BerandaController::class, 'dataPasien'])->name('dokter.data-pasien'); // view data pasien
//     // Route::get('/rekam-medis', [RekamMedisController::class, 'rekam_medis'])->name('dokter.rekam-medis'); // view rekam medis
//     // Route::get('/detail-rekam-medis', [DetailRekamMedisController::class, 'detail_rekam_medis'])->name('dokter.detail-rekam-medis'); // view detail rekam medis
//     Route::get('/detail-rekam-medis/tambah-detail-rekam-medis', [DetailRekamMedisController::class, 'tambahDetailRekamMedis'])->name('dokter.tambah-detail-rekam-medis'); // halaman tambah detail rekam medis
//     Route::get('/detail-rekam-medis/edit-detail-rekam-medis/{iddetail_rekam_medis}', [DetailRekamMedisController::class, 'editDetailRekamMedis'])->name('dokter.edit-detail-rekam-medis'); // halaman edit detail rekam medis
//     Route::post('/detail-rekam-medis/store', [DetailRekamMedisController::class, 'store'])->name('dokter.detail-rekam-medis.store'); // untuk tambah data detail rekam medis
//     Route::put('/detail-rekam-medis/update/{iddetail_rekam_medis}', [DetailRekamMedisController::class, 'update'])->name('dokter.detail-rekam-medis.update'); // untuk edit data detail rekam medis
//     Route::get('/detail-rekam-medis/hapus/{iddetail_rekam_medis}', [DetailRekamMedisController::class, 'destroy'])->name('dokter.detail-rekam-medis.hapus'); // untuk hapus data detail rekam medis
//     Route::get('/profil', [BerandaController::class, 'profilDokter'])->name('dokter.profil'); // view profil dokter
//     // Route::get('/beranda', [BerandaController::class, 'index'])->name('dokter.beranda'); // halaman dashboard dokter
// });

// middleware khusus untuk role perawat - view data pasien, CRUD rekam medis, view detail rekam medis, view profil
// Route::group(['middleware' => ['auth', 'cekrole:Perawat']], function () {
//     Route::get('/data-pasien', [BerandaController::class, 'dataPasien'])->name('perawat.data-pasien'); // view data pasien
//     // Route::get('/rekam-medis', [RekamMedisController::class, 'rekam_medis'])->name('perawat.rekam-medis'); // view rekam medis
//     Route::get('/rekam-medis/tambah-rekam-medis', [RekamMedisController::class, 'tambahRekamMedis'])->name('perawat.tambah-rekam-medis'); // halaman tambah rekam medis
//     Route::get('/rekam-medis/edit-rekam-medis/{idrekam_medis}', [RekamMedisController::class, 'editRekamMedis'])->name('perawat.edit-rekam-medis'); // halaman edit rekam medis
//     Route::post('/rekam-medis/store', [RekamMedisController::class, 'store'])->name('perawat.rekam-medis.store'); // untuk tambah data rekam medis
//     Route::put('/rekam-medis/update/{idrekam_medis}', [RekamMedisController::class, 'update'])->name('perawat.rekam-medis.update'); // untuk edit data rekam medis
//     Route::get('/rekam-medis/hapus/{idrekam_medis}', [RekamMedisController::class, 'destroy'])->name('perawat.rekam-medis.hapus'); // untuk hapus data rekam medis
//     // Route::get('/detail-rekam-medis', [DetailRekamMedisController::class, 'detail_rekam_medis'])->name('perawat.detail-rekam-medis'); // view detail rekam medis
//     Route::get('/profil', [BerandaController::class, 'profilPerawat'])->name('perawat.profil'); // view profil perawat
//     // Route::get('/beranda', [BerandaController::class, 'index'])->name('perawat.beranda'); // halaman dashboard perawat
// });
...
//     Route::get('/jadwal-temu-dokter', [BerandaController::class, 'jadwalTemuDokter'])->name('pemilik.jadwal-temu-dokter'); // view jadwal temu dokter
//     // Route::get('/rekam-medis', [RekamMedisController::class, 'rekam_medis'])->name('pemilik.rekam-medis'); // view rekam medis
//     Route::get('/profil', [BerandaController::class, 'profilPemilik'])->name('pemilik.profil'); // view profil pemilik
//     // Route::get('/pet', [PetController::class, 'pet'])->name('pemilik.pet'); // view pet
//     // Route::get('/beranda', [BerandaController::class, 'index'])->name('pemilik.beranda'); // halaman dashboard pemilik
// });
